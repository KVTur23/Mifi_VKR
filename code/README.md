# Запуск pipeline на сервере без Slurm

Инструкция рассчитана на запуск из IDE или обычного терминала на сервере. Все команды выполняются из корня проекта `code/`.
