...
Чтобы не дублировать парсинг конфига в каждом этапе
...
# Обязательные поля в конфиге — если чего-то нет, ошибка, иначе будет плохая генерация
...
def load_model_config(config_path: str) -> dict:
    ...
    Аргументы:
        config_path: путь до JSON-файла конфига
...
def load_prompt(prompt_path: str) -> str:
    """
    Читает текст промпта из файла и возвращает строку.
